...
class NerProcessor(DataProcessor):
    def get_train_examples(self, data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, "token_train.txt")), "train"
        )

    def get_dev_examples(self, data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, "token_dev.txt")), "dev"
        )

    def get_test_examples(self,data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, "token_test.txt")), "test"
        )
    ...
    def get_labels(self):
        ...
        return ["[PAD]","B-E","I-E", "B-Temporal","I-Temporal","B-SexualHistory","I-SexualHistory","B-Residence","I-Residence","B-Other","I-Other","B-EnvironmentalExposure","I-EnvironmentalExposure","B-MaritalStatus","I-MaritalStatus","B-Location","I-Location","B-LivingStatus","I-LivingStatus","B-ExposureHistory","I-ExposureHistory","B-QuitHistory","I-QuitHistory","B-MedicalCondition","I-MedicalCondition","B-Tobacco","I-Tobacco","B-Type","I-Type","B-Occupation","I-Occupation","B-Family","I-Family","B-Extent","I-Extent","B-InfectiousDiseases","I-InfectiousDiseases","B-Alcohol","I-Alcohol","B-Amount","I-Amount","B-PhysicalActivity","I-PhysicalActivity","B-History","I-History","B-Status","I-Status","B-LivingSituation","I-LivingSituation","B-Method","I-Method","B-Frequency","I-Frequency","B-Drug","I-Drug",'O', "X","[CLS]","[SEP]"]
